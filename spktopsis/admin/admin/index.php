<?php
$data = ambilData("SELECT * FROM admin");
...
if (isset($_POST['submit'])) {
    ...
    if (count($cekEmailCustomer)) {
        ...
        $cekEmailAdmin = ambilData("SELECT id_admin FROM admin WHERE email = '{$email}' AND id_admin != {$idadmin}");
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="index.php?page=tambahadmin">
                                        ...
                                        <?php foreach ($data as $d) :
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-success" data-id="<?= $d['id_admin'] ?>" onclick="editAdmin($(this).data('id'))" data-toggle="modal" data-target="#exampleModalCenter">
                                                        <i class="fa fa-pen"></i>
                                                    </button>
                                                    <button class="btn btn-danger" data-id="<?= $d['id_admin'] ?>" onclick="hapusData($(this).data('id'),'admin/ajax/hapusadmin.php','kriteria')">
